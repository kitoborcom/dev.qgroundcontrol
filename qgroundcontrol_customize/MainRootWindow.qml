...
ApplicationWindow {
    ...
    QtObject {
        ...
        // Priyanka
        property var                gotoLocationItemGlobal:         flightView.mapController._gotoLocationItem
    ...
    signal landRequest
    signal startMissionRequest
    signal pauseMissionRequest
    signal continueMissionRequest
    signal stopMissionRequest
