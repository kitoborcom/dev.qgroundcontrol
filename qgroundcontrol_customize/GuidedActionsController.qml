...
Item {
    ...
    Connections {
        ...
        function onStartMissionRequest() { startMissionRequest() }
        function onPauseMissionRequest() { pauseMissionRequest() }
        function onContinueMissionRequest() { continueMissionRequest() }
        function onStopMissionRequest() { stopMissionRequest() }
    ...
    function startMissionRequest() {
        confirmAction(actionStartMission)
    }

    function pauseMissionRequest() {
        confirmAction(actionPause)
    }

    function continueMissionRequest() {
        confirmAction(actionContinueMission)
    }

    function stopMissionRequest() {
        confirmAction(actionRTL)
    }
